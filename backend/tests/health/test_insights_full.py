#!/usr/bin/env python3
"""
Comprehensive check for Health Insights and Recommendations implementation.
Run from backend dir: python -m tests.health.test_insights_full
"""
import sys
from pathlib import Path

# Backend root (tests/health -> tests -> backend)
