...
class LocusGraphService:
    def __init__(self):
        ...
        print(f"DEBUG: LOCUSGRAPH_SERVER_URL = {settings.LOCUSGRAPH_SERVER_URL}")
        print(f"DEBUG: LOCUSGRAPH_AGENT_SECRET = {settings.LOCUSGRAPH_AGENT_SECRET[:20]}...")
        print(f"DEBUG: LOCUSGRAPH_GRAPH_ID = {settings.LOCUSGRAPH_GRAPH_ID}")
    ...
    async def store_event(
        ...
        if self.use_mock:
            ...
            print(f"DEBUG MOCK: Stored event with event_id={event_id}, event_kind={event_kind}, context_id={context_id}")
    ...
    async def retrieve_context(
        ...
        if self.use_mock:
            ...
            if query and query != "*":
                ...
                print(f"DEBUG MOCK: After query filter: {len(results)} events (from {before_filter})")
