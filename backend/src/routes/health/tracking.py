...
@router.post("/water/log", response_model=WaterLogResponse, status_code=status.HTTP_201_CREATED)
...
@router.post("/sleep/log", response_model=SleepLogResponse, status_code=status.HTTP_201_CREATED)
...
async def get_sleep_history(
    date_from: Optional[date] = Query(None, description="Filter by date from (YYYY-MM-DD)"),
...
@router.post("/exercise/log", response_model=ExerciseLogResponse, status_code=status.HTTP_201_CREATED)
...
@router.post("/mood/log", response_model=MoodLogResponse, status_code=status.HTTP_201_CREATED)
