...
class SleepLogCreate(BaseModel):
    ...
    notes: Optional[str] = Field(None, description="Optional notes about the sleep session")
...
class SleepLogResponse(BaseModel):
    ...
    sleep_start: datetime = Field(..., description="When sleep started")
    sleep_end: datetime = Field(..., description="When sleep ended")
    quality: Literal["poor", "fair", "good", "excellent"] = Field(..., description="Quality of sleep")
    notes: Optional[str] = Field(None, description="Optional notes about the sleep session")
