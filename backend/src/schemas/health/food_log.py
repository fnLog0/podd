...
class FoodLogBase(BaseModel):
    ...
    calories: Optional[float] = Field(None, ge=0, description="Calories in the food item")
    ...
    logged_at: Optional[datetime] = Field(None, description="Timestamp when food was logged")
...
class FoodLogCreate(FoodLogBase):
    ...
    related_to: list[str] = Field(
        ...
        description="IDs of related events to link this log to"
    )
