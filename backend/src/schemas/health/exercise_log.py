...
class ExerciseLogCreate(BaseModel):
    ...
    logged_at: Optional[datetime] = Field(None, description="Timestamp when exercise was logged")
...
class ExerciseLogResponse(BaseModel):
    ...
    intensity: Literal["low", "moderate", "high", "vigorous"] = Field(..., description="Intensity level")
