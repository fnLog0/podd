...
class MedicationResponse(MedicationBase):
    ...
    created_at: datetime = Field(..., description="Timestamp when medication was created")
    updated_at: datetime = Field(..., description="Timestamp when medication was last updated")
