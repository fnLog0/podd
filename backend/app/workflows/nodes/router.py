...
FOOD_KEYWORDS = {
    ...
    "lunch", "dinner", "food", "meal",
}

MED_KEYWORDS = {
    "medicine", "dawai", "tablet", "goli", "prescription",
}

HEALTH_KEYWORDS = {
    "blood pressure", "sugar", "bp", "weight", "symptoms", "diagnosis",
}

RECOMMENDATION_KEYWORDS = {
    "suggest", "recommend", "recipe", "kya khau", "what should i eat",
}
